...
// @name:zh-CN   自动播放增强（跳过片头/片尾，自动下一集）
...
(function () {
    ...
    // 初始化时间节点
    let introDuration = localStorage.getItem('introDuration') || -0.1;
    let outroDuration = localStorage.getItem('outroDuration') || -0.1;
    let adStart = localStorage.getItem('adStart') || -0.1;
    let adEnd = localStorage.getItem('adEnd') || -0.1;
